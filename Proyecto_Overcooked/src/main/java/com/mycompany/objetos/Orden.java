...
public class Orden {
    ...
    public Orden(String nombre, Ingrediente[] receta,  int puntos) {
        this.nombre = nombre;
        this.puntos = puntos;
    ...
    public static Orden hamburguesaCarne() {
        return new Orden("Hamburguesa de carne", new Ingrediente[]{Ingrediente.pan, Ingrediente.carne, Ingrediente.pan}, 5);
    }

    public static Orden hamburguesaQueso() {
        return new Orden("Hamburguesa con queso", new Ingrediente[]{Ingrediente.pan, Ingrediente.carne, Ingrediente.queso , Ingrediente.pan}, 10);
    }

    public static Orden hamburguesaClasica() {
        return new Orden("Hamburguesa clásica", new Ingrediente[]{Ingrediente.pan, Ingrediente.carne, Ingrediente.lechuga, Ingrediente.queso, Ingrediente.pan}, 15);
    }
